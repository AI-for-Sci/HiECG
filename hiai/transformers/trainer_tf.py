...
class TFTrainer:
    ...
    Args:
        ...
        train_dataset (:class:`~tf.preprocess.Dataset`, `optional`):
        ...
        eval_dataset (:class:`~tf.preprocess.Dataset`, `optional`):
    ...
    def get_train_tfdataset(self) -> tf.data.Dataset:
        """
        Returns the training :class:`~tf.preprocess.Dataset`.
    ...
    def get_eval_tfdataset(self, eval_dataset: Optional[tf.data.Dataset] = None) -> tf.data.Dataset:
        """
        Returns the evaluation :class:`~tf.preprocess.Dataset`.
    ...
    def get_test_tfdataset(self, test_dataset: tf.data.Dataset) -> tf.data.Dataset:
        """
        Returns a test :class:`~tf.preprocess.Dataset`.
