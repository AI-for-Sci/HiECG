...
_import_structure = {
    ...
    "models.signal2vec": [
        "SIGNAL_2_VEC_PRETRAINED_CONFIG_ARCHIVE_MAP",
        "Signal2VecConfig",
        "Signal2VecCTCTokenizer",
        "Signal2VecFeatureExtractor",
        "Signal2VecProcessor",
        "Signal2VecTokenizer",
    ],
...
if is_torch_available():
    ...
    _import_structure["preprocess.datasets"] = [
        "GlueDataset",
    ...
    _import_structure["models.signal2vec"].extend(
        [
...
if is_flax_available():
    ...
    _import_structure["models.signal2vec"].extend(
        ["FlaxSignal2VecForCTC", "FlaxSignal2VecorPreTraining", "FlaxSignal2VecModel", "FlaxSignal2VecPreTrainedModel"]
    )
else:
...
if TYPE_CHECKING:
    ...
    if is_torch_available():
        ...
        from .models.signal2vec import (
            SIGNAL_2_VEC_2_PRETRAINED_MODEL_ARCHIVE_LIST,
            Signal2VecForCTC,
            Signal2VecForMaskedLM,
            Signal2VecForPreTraining,
            Signal2VecForSequenceClassification,
    ...
    if is_tf_available():
        ...
        from .models.signal2vec import (
            TF_SIGNAL_2_VEC_2_PRETRAINED_MODEL_ARCHIVE_LIST,
            TFSignal2VecForCTC,
            TFSignal2VecModel,
            TFSignal2VecPreTrainedModel,
        )
...
if not is_tf_available() and not is_torch_available() and not is_flax_available():
    logger.warning(
        ...
        "and file/preprocess utilities can be used."
    )
