...
def default_data_collator(features: List[InputDataClass], return_tensors="pt") -> Dict[str, Any]:
    """
    Very simple preprocess collator that simply collates batches of dict-like objects and performs special handling for
...
class DataCollatorWithPadding:
    ...
    Args:
        tokenizer (:class:`~transformers.PreTrainedTokenizer` or :class:`~transformers.PreTrainedTokenizerFast`):
            The tokenizer used for encoding the preprocess.
...
def _torch_collate_batch(examples, tokenizer, pad_to_multiple_of: Optional[int] = None):
    ...
    # Creating the full tensor and filling it with our preprocess.
...
class DataCollatorForLanguageModeling(DataCollatorMixin):
    ...
    .. note::
        ...
        For best performance, this preprocess collator should be used with a dataset having items that are dictionaries or
