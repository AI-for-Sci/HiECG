...
class InputFeatures:
    """
    A single set of features of preprocess. Property names are the same names as the corresponding inputs to a model.
...
class DataProcessor:
    """Base class for preprocess converters for sequence classification preprocess sets."""
    ...
    def get_labels(self):
        """Gets the list of labels for this preprocess set."""
        raise NotImplementedError()
...
class SingleSentenceClassificationProcessor(DataProcessor):
    """Generic processor for a single sentence classification preprocess set."""
