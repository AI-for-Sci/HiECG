...
class TrainerState:
    ...
    Args:
        ...
        is_hyper_param_search (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            impact the way preprocess will be logged in TensorBoard.
    """
...
class TrainerCallback:
    ...
    Args:
        ...
        train_dataloader (:obj:`torch.utils.preprocess.DataLoader`, `optional`):
            The current dataloader used for training.
        eval_dataloader (:obj:`torch.utils.preprocess.DataLoader`, `optional`):
            The current dataloader used for training.
