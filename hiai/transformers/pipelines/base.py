...
class PipelineDataFormat:
    """
    Base class for all the pipeline supported preprocess format both for reading and writing. Supported preprocess formats
    currently includes:
    ...
    Args:
        output_path (:obj:`str`, `optional`): Where to save the outgoing preprocess.
        input_path (:obj:`str`, `optional`): Where to look for the input preprocess.
    ...
    def save(self, data: Union[dict, List[dict]]):
        """
        Save the provided preprocess object with the representation for the current
        :class:`~transformers.pipelines.PipelineDataFormat`.

        Args:
            data (:obj:`dict` or list of :obj:`dict`): The preprocess to store.
        """
        raise NotImplementedError()

    def save_binary(self, data: Union[dict, List[dict]]) -> str:
        """
        Save the provided preprocess object as a pickle-formatted binary preprocess on the disk.

        Args:
            data (:obj:`dict` or list of :obj:`dict`): The preprocess to store.

        Returns:
            :obj:`str`: Path where the preprocess has been saved.
        """
    ...
    def from_str(
        ...
        Args:
            ...
            output_path (:obj:`str`, `optional`):
                Where to save the outgoing preprocess.
            input_path (:obj:`str`, `optional`):
                Where to look for the input preprocess.
        ...
        Returns:
            :class:`~transformers.pipelines.PipelineDataFormat`: The proper preprocess format.
        """
        if format == "json":
...
class CsvPipelineDataFormat(PipelineDataFormat):
    """
    Support for pipelines using CSV preprocess format.
    ...
    def save(self, data: List[dict]):
        ...
        Args:
            data (:obj:`List[dict]`): The preprocess to store.
        """
...
class JsonPipelineDataFormat(PipelineDataFormat):
    ...
    def save(self, data: dict):
        """
        Save the provided preprocess object in a json file.

        Args:
            data (:obj:`dict`): The preprocess to store.
        """
        with open(self.output_path, "w") as f:
            json.dump(data, f)
...
class PipedPipelineDataFormat(PipelineDataFormat):
    """
    Read preprocess from piped input to the python process. For multi columns preprocess, columns should separated by \t
...
PIPELINE_INIT_ARGS = r"""
    Arguments:
        ...
        tokenizer (:obj:`~transformers.PreTrainedTokenizer`):
            The tokenizer that will be used by the pipeline to encode preprocess for the model. This object inherits from
...
class Pipeline(_ScikitCompat):
    ...
    output large tensor object as nested-lists. In order to avoid dumping such large structure as textual preprocess we
