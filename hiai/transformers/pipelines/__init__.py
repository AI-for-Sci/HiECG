...
def pipeline(
    ...
    **kwargs
    ...
    Pipelines are made of:
        ...
        - Some (optional) post preprocess for enhancing model's output.
    ...
    Args:
        ...
        tokenizer (:obj:`str` or :obj:`~transformers.PreTrainedTokenizer`, `optional`):
            The tokenizer that will be used by the pipeline to encode preprocess for the model. This can be a model
        ...
        feature_extractor (:obj:`str` or :obj:`~transformers.PreTrainedFeatureExtractor`, `optional`):
            The feature extractor that will be used by the pipeline to encode preprocess for the model. This can be a model
