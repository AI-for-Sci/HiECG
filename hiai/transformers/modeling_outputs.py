...
class BaseModelOutputWithPooling(ModelOutput):
    ...
    Args:
        ...
        pooler_output (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, hidden_size)`):
            Last layer hidden-state of the first token of the sequence (classification token) after further preprocess
            through the layers used for the auxiliary pretraining task. E.g. for BERT-family of models, this returns
            the classification token after preprocess through a linear layer and a tanh activation function. The linear
