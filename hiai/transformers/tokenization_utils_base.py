...
class BatchEncoding(UserDict):
    ...
    def __getstate__(self):
        return {"preprocess": self.data, "encodings": self._encodings}

    def __setstate__(self, state):
        if "preprocess" in state:
            self.data = state["preprocess"]
...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def as_target_tokenizer(self):
        ...
        sequence-to-sequence models that need a slightly different preprocess for the labels.
        """
        yield
