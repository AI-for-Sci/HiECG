...
"""Tokenization class for Signal2Vec."""
...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "facebook/Signal2Vec-base-960h": "https://huggingface.co/facebook/Signal2Vec-base-960h/resolve/main/vocab.json",
    },
    "tokenizer_config_file": {
        "facebook/Signal2Vec-base-960h": "https://huggingface.co/facebook/Signal2Vec-base-960h/resolve/main/tokenizer_config.json",
    },
}

# Signal2Vec has no max input length
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {"facebook/Signal2Vec-base-960h": sys.maxsize}

Signal2Vec_KWARGS_DOCSTRING = r"""
...
class Signal2VecCTCTokenizer(PreTrainedTokenizer):

    """
    Constructs a Signal2VecCTC tokenizer.
    ...
    def _decode(
        ...
        """
        special _decode function is needed for Signal2VecTokenizer because added tokens should be treated exactly the
    ...
    def _add_tokens(self, new_tokens: Union[List[str], List[AddedToken]], special_tokens: bool = False) -> int:
        ...
        Examples::
            ...
            tokenizer = Signal2VecCTCTokenizer.from_pretrained('facebook/Signal2Vec-base-960h')
            model = Signal2VecForCTC.from_pretrained('facebook/Signal2Vec-base-960h')
...
class Signal2VecTokenizer(PreTrainedTokenizer):
    """
    Constructs a Signal2Vec tokenizer.
    ...
    Args:
        ...
        do_normalize (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            improve the performance for some models, *e.g.*, `Signal2Vec-lv60
            <https://huggingface.co/models?search=lv60>`__.
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformers.Signal2VecTokenizer.__call__` should return :obj:`attention_mask`.

            .. note::

                Signal2Vec models that have set ``config.feat_extract_norm == "group"``, such as `Signal2Vec-base
                <https://huggingface.co/facebook/Signal2Vec-base-960h>`__, have **not** been trained using
                ...
                For Signal2Vec models that have set ``config.feat_extract_norm == "layer"``, such as `Signal2Vec-lv60
                <https://huggingface.co/facebook/Signal2Vec-large-960h-lv60-self>`__, :obj:`attention_mask` should be
    ...
    pretrained_vocab_files_map = {
        ...
        "tokenizer_config_file": {
            "facebook/Signal2Vec-base-960h": "https://huggingface.co/facebook/Signal2Vec-base-960h/resolve/main/tokenizer.json",
        },
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        warnings.warn(
            "The class `Signal2VecTokenizer` is deprecated and will be removed in version 5 of Transformers. Please use `Signal2VecProcessor` or `Signal2VecCTCTokenizer` instead.",
            FutureWarning,
        )
    ...
    @add_end_docstrings(Signal2Vec_KWARGS_DOCSTRING)
    def __call__(
        self,
