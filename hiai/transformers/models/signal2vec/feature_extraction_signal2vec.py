...
"""
Feature extractor class for Signal2Vec
"""
...
class Signal2VecFeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a Signal2Vec feature extractor.
    ...
    Args:
        ...
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformers.Signal2VecFeatureExtractor.__call__` should return :obj:`attention_mask`.
