...
class Signal2VecConfig(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        apply_spec_augment (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether to apply *SpecAugment* preprocess augmentation to the outputs of the feature extractor. For reference see
