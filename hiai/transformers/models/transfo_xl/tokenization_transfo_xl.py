...
class LMOrderedIterator(object):
    def __init__(self, data, bsz, bptt, device="cpu", ext_len=None):
        """
        preprocess -- LongTensor -- the LongTensor is strictly ordered
        """
        self.bsz = bsz
        self.bptt = bptt
        ...
        # Evenly divide the preprocess across the bsz batches.
...
class LMShuffledIterator(object):
    def __init__(self, data, bsz, bptt, device="cpu", ext_len=None, shuffle=False):
        """
        preprocess -- list[LongTensor] -- there is no order among the LongTensors
        """
        self.data = data
    ...
    def stream_iterator(self, sent_stream):
        # streams for each preprocess in the batch
        ...
        while True:
            # preprocess   : [n_retain+bptt x bsz]
            # target : [bptt x bsz]
