...
class TapasTokenizer(PreTrainedTokenizer):
        ...
        **kwargs
        ...
        Args:
            table (:obj:`pd.DataFrame`):
                Table containing tabular preprocess. Note that all cell values must be text. Use `.astype(str)` on a Pandas
            ...
            answer_coordinates (:obj:`List[Tuple]` or :obj:`List[List[Tuple]]`, `optional`):
                ...
                be a (row_index, column_index) pair. The first preprocess row (not the column header row) has index 0. The
        ...
        **kwargs
        ...
        Args:
            ...
            answer_coordinates (:obj:`List[Tuple]` or :obj:`List[List[Tuple]]`, `optional`):
                ...
                column_index) pair. The first preprocess row (not the column header row) has index 0. The first column has
    ...
    def encode(
        ...
        **kwargs
        ...
        which are necessary for the model to work correctly. Use that method if you want to build your preprocess on
        ...
        **kwargs
        ...
        Args:
            ...
            answer_coordinates (:obj:`List[Tuple]` or :obj:`List[List[Tuple]]`, `optional`):
                ...
                list of one or more tuples. Each tuple must be a (row_index, column_index) pair. The first preprocess row
    ...
    def convert_logits_to_predictions(self, data, logits, logits_agg=None, cell_classification_threshold=0.5):
        ...
        """
        # input preprocess is of type float32
...
class BasicTokenizer(object):
    ...
    def tokenize(self, text, never_split=None):
        ...
        # matter since the English models were not trained on any Chinese preprocess
        # and generally don't have any Chinese preprocess in them (there are Chinese
